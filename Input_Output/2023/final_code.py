...
def preprocess_data():
    ...
    excel_path = os.path.join(script_dir, '2023.xlsx')        #change name of Excel document for input
...
def save_result(df_TAs, df_ass, df_c, happ, df_TA_req, df_ta_task):
    script_dir = os.path.dirname(os.path.abspath(__file__))
    excel_path = os.path.join(script_dir, '2024.xlsx')          # Change name of Excel document for output
